...
将刚才导出来的 gltf 文件拖入编辑器或者 GLTF 预览器，若材质类型为 **UnlitMaterial**，说明已经开启了 GLTF 的 [KHR\_materials\_unlit](https://github.com/KhronosGroup/glTF/tree/master/extensions/2.0/Khronos/KHR_materials_unlit) 插件。
