...
In order to reduce communication costs, this article lists several common methods for making AnimationClips and how to export glTF to facilitate the direct use of Galacean Engine, or through the [glTF preview](https://galacean.antgroup.com/#/gltf-viewer) page for verification .
...
1.  At this point, the glTF file containing the AnimationClips just made has been exported, and you can visit Galacean' [glTF preview](https://galacean.antgroup.com/#/gltf-viewer) for verification.
