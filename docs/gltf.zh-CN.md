...
| [KHR_materials_unlit](https://github.com/galacean/engine/blob/main/packages/loader/src/gltf/extensions/KHR_materials_unlit.ts) | 支持 [Unlit 材质](https://galacean.antgroup.com/0.4/docs/artist-unlit-cn) |
...
| [KHR_texture_transform](https://github.com/galacean/engine/blob/main/packages/loader/src/gltf/extensions/KHR_texture_transform.ts) | 支持纹理的缩放位移变换，可以参考 [TilingOffset](https://galacean.antgroup.com/0.4/examples#tiling-offset) 案例 |
