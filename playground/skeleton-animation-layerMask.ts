...
WebGLEngine.create({ canvas: "canvas" }).then((engine) => {
  ...
  engine.resourceManager
    ...
    .then((gltfResource) => {
      ...
      const mask = AnimatorLayerMask.createByEntity(defaultSceneRoot);
      // mask.setEntityPath("", true, true);
      // mask.setEntityPath("mixamorig:Hips/mixamorig:Spine/mixamorig:Spine1/", false, true);
      mask.setPathMaskActive("mixamorig:Hips/mixamorig:Spine/mixamorig:Spine1/", false, true);
