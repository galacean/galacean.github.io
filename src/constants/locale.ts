export const translationsData: { [lang: string]: any } = {
  ...
  en: {
    ...
    "app.home.effects.intro": "Galacean Effects is an online motion effects editor focused on mobile devices.",
