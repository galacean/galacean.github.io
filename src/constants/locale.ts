export const translationsData: { [lang: string]: any } = {
  "zh-CN": {
    ...
    "app.home.engine": "引擎",
    "app.home.engine.use": "了解一下",
    "app.home.engine.intro": "Galacean Engine 的介绍",
    "app.home.effect": "Effect",
    "app.home.effect.use": "立即使用",
    "app.home.effect.intro": "Galacean Effects是一款专注于移动端的在线化动效编辑器。",
    "app.home.editor": "编辑器",
  ...
  en: {
    ...
    "app.home.engine": "引擎",
    "app.home.engine.use": "Get to learn",
    "app.home.engine.intro": "Introduction to Galacean Engine",
    "app.home.effect": "Effect",
    "app.home.effect.use": "Get started",
    "app.home.effect.intro": "Introduction to Galacean Effects",
