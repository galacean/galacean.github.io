export const translationsData: { [lang: string]: any } = {
  "zh-CN": {
    ...
    "app.header.menu.effects.doc": "Effects 文档",
    "app.header.menu.effects.api": "Effects API",
    "app.header.menu.effects.examples": "Effects 示例",
    ...
    "app.home.engine.apply": "申请内测",
    "app.home.engine.use": "立即使用",
    ...
    "app.home.effects.intro": "100% 还原，制作结果等于上线效果，显著降低动效相关的实现成本。产物性能优越，Web、iOS、Android 三端一致。",
  ...
  en: {
    ...
    "app.header.menu.ecosystem.editor": "Engine Editor",
    "app.header.menu.ecosystem.editor.description":
      "Online visual workflow for building scenes, animations and scripts",
    "app.header.menu.ecosystem.effects-editor": "Effects Editor",
    ...
    "app.header.menu.effects": "Effects",
    "app.header.menu.effects.editor": "Effects Editor",
    "app.header.menu.effects.doc": "Effects Document",
    "app.header.menu.effects.api": "Effects API",
    "app.header.menu.effects.examples": "Effects Examples",
    ...
    "app.home.engine": "Galacean Engine",
    "app.home.engine.apply": "Join the waitlist",
    "app.home.engine.use": "Open engine editor",
    "app.home.engine.intro":
    ...
    "app.home.effects.intro": "100% restoration, production results equal to online effects, significantly reducing the implementation cost of animation. The product has superior performance and is consistent across Web, iOS, and Android platforms.",
