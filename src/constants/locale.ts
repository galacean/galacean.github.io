export const translationsData: { [lang: string]: any } = {
  'zh-CN': {
    ...
    'app.header.menu.artist.docs.description': '面向美术，包含常用美术软件使用指南和对接引擎的最佳实践',
    'app.header.menu.editor': '编辑器',
    'app.header.menu.editor.docs': '编辑器文档',
    'app.header.menu.editor.docs.description': '面向美术和开发，编辑器的基础操作和引擎功能的可视化使用',
    'app.header.menu.ecosystem': '生态系统',
    'app.header.menu.ecosystem.tool': '工具',
    'app.header.menu.ecosystem.editor': '编辑器 (马上就来)',
    'app.header.menu.ecosystem.editor.description': '在线完成场景搭建、动画编辑、脚本开发等流程',
    'app.header.menu.ecosystem.miniprogram': '小程序',
    'app.header.menu.ecosystem.gltfviewer': 'glTF 查看器',
    'app.header.menu.ecosystem.gltfviewer.description': '快速预览 glTF2.0 格式的模型，生成引擎的 HDR 环境贴图',
    'app.header.menu.ecosystem.createapp': 'Create Oasis App',
    'app.header.menu.ecosystem.createapp.description': '创建 React、Vue、小程序等类型的前端应用的脚手架',
    ...
    'app.home.editor.intro': '提供场景搭建、资产处理、动画编辑、脚本编辑等能力，大幅提升 2D、3D 互动项目的开发效率。',
  ...
  en: {
    ...
    'app.header.menu.engine.docs': 'Engine Docs',
    'app.header.menu.engine.docs.description': 'For developers, introduce how to get started, basic concepts and usage of engine',
    'app.header.menu.engine.api': 'API',
    ...
    'app.header.menu.artist.docs.description': 'For artists, including guides for DCC tools and best practices for using engines',
    'app.header.menu.editor': 'Editor',
    'app.header.menu.editor.docs.description': 'For artists and developers, the basic operation of the editor and the visual usage of engine functions',
    ...
    'app.header.menu.ecosystem.editor.description': 'Online visual workflow for building scenes, animations and scripts',
    'app.header.menu.ecosystem.miniprogram': 'Mini-program',
    'app.header.menu.ecosystem.gltfviewer': 'glTF Viewer',
    'app.header.menu.ecosystem.gltfviewer.description': 'Quickly preview glTF2.0 models, generate HDR environment maps for the engine',
    'app.header.menu.ecosystem.createapp': 'Create Oasis App',
    'app.header.menu.ecosystem.createapp.description': 'Scaffolding for front-end applications created by React, Vue, and mini-program',
    ...
    'app.home.editor.intro': 'Scene building, resource processing, animation editing, script editing, greatly improving the development efficiency of 2D and 3D interactive projects.',
