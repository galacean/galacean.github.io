  ...
  const items = isHomePage ? [
    {
      ...
      children: [
        {
          label: <a rel='noopener noreferrer' href={`/engine/docs/${context.version}/${context.lang}/getting-started-overview`}>{formatMessage({ id: 'app.header.menu.engine.docs' })}</a>
        },
        {
          label: <a rel='noopener noreferrer' href={`/engine/api/${context.version}`}>{formatMessage({ id: 'app.header.menu.engine.api' })}</a>,
        },
        {
          label: <a rel='noopener noreferrer' href={`/engine/examples/${context.version}`}>{formatMessage({ id: 'app.header.menu.engine.examples' })}</a>,
        },
        {
